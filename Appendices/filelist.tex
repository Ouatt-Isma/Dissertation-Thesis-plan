...
\section{Accuracy plots during \ac{NN} Training}
...
\centering
\subfloat[{mnist\_128\_trust\_trust, ps=1}]{%
  \includegraphics[width=0.5\textwidth]{latex/NN_Train_mnist_128_trust_trust_PathSize_1__ipta_table2a.pdf}%
}
\subfloat[{mnist\_128\_trust\_trust, ps=10}]{%
  \includegraphics[width=0.5\textwidth]{latex/NN_Train_mnist_128_trust_trust_PathSize_10__ipta_table2a.pdf}%
}
\\
\subfloat[{mnist\_128\_trust\_trust, ps=27}]{%
  \includegraphics[width=0.5\textwidth]{latex/NN_Train_mnist_128_trust_trust_PathSize_27__ipta_table2a.pdf}%
}
\subfloat[{mnist\_128\_trust\_trust, ps=4}]{%
  \includegraphics[width=0.5\textwidth]{latex/NN_Train_mnist_128_trust_trust_PathSize_4__ipta_table2a.pdf}%
}
\caption{IPTA by class opinion}
\end{figure}
...
\centering
\subfloat[{mnist\_128\_trust\_trust, ps=1}]{%
  \includegraphics[width=0.5\textwidth]{latex/NN_Train_mnist_128_trust_trust_PathSize_1__ipta_trust_2a_vs_2c.pdf}%
}
\subfloat[{mnist\_128\_trust\_trust, ps=10}]{%
  \includegraphics[width=0.5\textwidth]{latex/NN_Train_mnist_128_trust_trust_PathSize_10__ipta_trust_2a_vs_2c.pdf}%
}
\\
\subfloat[{mnist\_128\_trust\_trust, ps=27}]{%
  \includegraphics[width=0.5\textwidth]{latex/NN_Train_mnist_128_trust_trust_PathSize_27__ipta_trust_2a_vs_2c.pdf}%
}
\subfloat[{mnist\_128\_trust\_trust, ps=4}]{%
  \includegraphics[width=0.5\textwidth]{latex/NN_Train_mnist_128_trust_trust_PathSize_4__ipta_trust_2a_vs_2c.pdf}%
}
\caption{IPTA per class opinion vs weighted softmax}
\end{figure}
