...
In this chapter, these contributions are unified and generalized into a methodology for structuring trust assessment problems and deriving trust evaluations so that it can be instantiated across different \ac{ML} contexts.
