...
\label{chap:patas}
\todo{If not done at the begining of dataset, tp-patas and calibration chapter at a small box to show the instantiation of the methodology. Also when explaining trust node maybe say that this is the corresponding expression to assess and the evaluation is when we compute the value}
...
\caption{
    Functional flow of \ac{PaTAS-TP} integrated with a \ac{NN}, showing the interaction between the Trust Feedforward (TF), Parameter-Trust Update (B), and GenIPTA/Output-Trust Aggregation (I) modules across the training and inference phases.}
