...
\todo{make clear what is propagation: the transitive dependencies between components, whereby the trustworthiness of one component conditions that of the next}
